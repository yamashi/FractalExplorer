...
/// @file
/// @brief Ownership policy classes for thor::CopiedPtr and thor::MovedPtr
...
/// @brief Ownership policy that performs no copy.
/// @details This is the default ownership policy of thor::MovedPtr. Since movable objects needn't be copyable, the
///  requirements are lower like this. If you want to transfer ownership from a MovedPtr to a CopiedPtr, you should
///  use another policy instead.
template <typename T>
struct NoCopy
{
...
/// @brief Ownership policy that performs a deep value copy.
...
/// @brief Ownership policy that performs a deep copy depending on the object's dynamic type.
...
/// @brief Ownership policy that calls a virtual Clone() function.
